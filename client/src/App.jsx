...
function App() {
  ...
  const extractRepoUrl = (description) => {
    ...
    //if github repo is found in the description return the repo URL
    return match ? match[0] : null;
  };

  //return more details about video
  ...
  //return basic info about videos
  const searchCodingTutorials = async (searchQuery, maxResults) => {
    try {
      ...
      //iterating through the videos found and getting the description
      ...
      const videoResults = videoDetails
        ...
        .filter((video) => video.repoUrl !== null); //only retrieving videos with a repoUrl
      ...
      <div className="max-w-2xl w-full bg-white rounded-lg shadow-2xl shadow-purple-900 p-10">
        ...
        <div className="flex mb-4">
          ...
          <button
            ...
            disabled={isLoading}
            className="bg-purple-500 text-white px-4 py-2 rounded-br-3xl hover:bg-purple-800 focus:outline-none focus:ring-2 focus:ring-purple-800s disabled:opacity-50"
          >
